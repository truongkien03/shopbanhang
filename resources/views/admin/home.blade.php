...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div style="width: -webkit-fill-available;background: #28a745 linear-gradient(180deg,#3379b1,#250060) repeat-x!important;" class="card bg-gradient-success">
                                            ...
                                            <table class="table table-sm">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td data-action="selectDay" data-day="11/11/2022" class="day active today">11</td>
